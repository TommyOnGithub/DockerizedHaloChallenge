...
from forms import (SetForm, GetForm, SignupForm, LoginForm)
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://postgresql:password@postgresql/dict_app_db'
...
if __name__ == "__main__":
    ...
    time.sleep(3) # Wait for PostgreSQL db container to be set up
    db.create_all()
